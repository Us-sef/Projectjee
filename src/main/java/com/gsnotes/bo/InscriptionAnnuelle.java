...
@Entity
public class InscriptionAnnuelle implements Comparable<InscriptionAnnuelle> {
	...
	@Override
	public int compareTo(InscriptionAnnuelle o) {
		int x=this.etudiant.getNom().compareTo(o.etudiant.getNom());
		if(x==0){
			return this.etudiant.getPrenom().compareTo(o.etudiant.getPrenom());
		}
		return x;
	}
}
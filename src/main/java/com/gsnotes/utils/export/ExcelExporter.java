...
public class ExcelExporter {
	...
	private void writeDataLines(int r,int col) {
		int rowCount = r;
	...
	public void exportInbureau() throws IOException {
		writeHeaderLine();
		writeDataLines(1,0);
		FileOutputStream out = new FileOutputStream(new File("C:/Users/User/IdeaProjects/GFGsheet.xlsx"));
		workbook.write(out);
		out.close();
	}

	public void exportModule(HttpServletResponse response,int r,int c) throws IOException{
		writeDataLines(r,c);
